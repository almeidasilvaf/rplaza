...
database of plant comparative genomics. `rplaza` can be used to retrieve data
from PLAZA (e.g., sequences, genome annotation, functional annotation, etc)
as R objects using standard Bioconductor data classes.
