# Getting help with `rplaza`

Thank you for using `rplaza`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/rplaza`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/rplaza),
...
[search issues and pull requests](https://github.com/almeidasilvaf/rplaza/issues)
